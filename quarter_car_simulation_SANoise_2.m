...
smart.enabled             = true;       % master switch
smart.include_gravity     = true;       % phones output specific force (≈ +g at rest)
smart.euler_body2dev_deg  = [0, 8, 0];  % [yaw_Z, pitch_Y, roll_X] in deg (typical dash tilt)
smart.mount_fc_hz         = 35;         % dash/mount low-pass corner (Hz). [] to skip
...
smart.range_g             = 4;          % ±g range of the device (±2/±4/±8)
...
damage_scenario_selection = 'Bumps_Only';
